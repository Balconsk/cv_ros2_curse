...
def generate_launch_description():
    ...
    # Package Directories
    this_pkg = get_package_share_directory('tracking_4')
    ...
    set_gazebo_model_path_env = AppendEnvironmentVariable("GZ_SIM_RESOURCE_PATH", "/home/nebalcon/ros2_project/cv_ros2/src/tracking_4/resource")
